...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27A1B60B65");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4D37EBC44");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB858E638E5A");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__4659622919729986");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF586EF0CD9");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C3A54440E");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164AF85A998").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D36F351435");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C34F437D3");
